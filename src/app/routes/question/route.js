...
export async function POST(request) {
    try {
        ...
        if (Array.isArray(requestData)) {
            ...
            const { topic, name, link, status, notes, data, sheetname, difficulty, star, score } = requestData;
            await connectMongoDB();
            await Question.create({ topic, name, link, status, notes,  data, sheetname, difficulty, star, score });
